import { Image, VStack, Icon } from "@chakra-ui/react";
...
export const Icons = () => {
  ...
  const handleHover = () => {
    gsap.to(elementRef.current, {
      scale: 1.2, // Increase the scale to 1.2
      duration: 0.3, // Animation duration in seconds
    });
  };
  const handleHover2 = () => {
    gsap.to(elementRef.current, {
      scale: 1.0, // Increase the scale to 1.2
      duration: 0.3, // Animation duration in seconds
    });
  };
  const handleHover3 = () => {
  ...
  return (
    <VStack gap="5" className="scrl flex-col" >
      <Icon viewBox="0 0 24 24" boxSize={10} color="gray" id="scrl1" ref={elementRef} onMouseEnter={handleHover}
    onMouseLeave={handleHover2}>
      ...
      <Icon viewBox="0 0 32 32" boxSize={10} color="gray" id="scrl2"
      ref={elementRef2} onMouseEnter={handleHover3}
      ...
      <Icon viewBox="0 0 24 24" boxSize={10} color="gray" id="scrl3"
      ref={elementRef3} onMouseEnter={handleHover5}
